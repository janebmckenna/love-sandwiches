...
def update_worksheet(data, worksheet):
    """
    Recieves a row of data and inserts it into the correct worksheet
    """
...
def calculate_stock_data(data):
    """
    Calculate the average sales for each sandwich in the last 5 market days
    """
...
def get_stock_values(data):
    """
    Displays the prep values for the Love Sandwiches team
    """
    stock = SHEET.worksheet('stock').get_all_values()
    headings = stock[0]
    dictionary = {}
    for heading, value in zip(headings, data):
        dictionary[heading] = value
    return f'Please Make the following sandwiches for the next market:\n {dictionary}'
